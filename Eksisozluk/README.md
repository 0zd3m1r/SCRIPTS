...
```
1-Chrome için Get Cookies.txt eklentisi kur ve www.eksisozluk.com kullanıcı girişi yap.
2-Giriş yapıldıktan sonra eklenti ile cookie bilgilerini Export et.
3-Bir doküman editörü ile export edilen dosya açıp, # ile başlayan ilk üç satır ve altındaki boş satırı silerek cookie.txt olarak python dosyasının bulunduğu dizine kopyala.
```
